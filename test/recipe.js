...
var app = require("../index"), mongoose = require("mongoose"), Recipe = require("../models/recipe"), kraken = require("kraken-js"), request = require("supertest"), assert = require("assert");
    ...
    it("should add a recipe and find it", function(done) {
        Recipe.create({
            ...
            ingredients: [ {
                ...
                amount: .5,
                measure: "tsp",
                ingredient: "awesomeness"
            }, {
                raw_amount: "1/4",
                amount: .25,
                measure: "tsp",
                ingredient: "coolitude"
            } ]
        }, function(e, o) {
            assert(!e, "E is null");
